...
#ifndef ERP42_RACING_UTIL__LOG_HPP_
#define ERP42_RACING_UTIL__LOG_HPP_

#include <string>

// Terminal log handler macro
#define ERP42_RACING_DEBUG(msg, ...) erp42_racing_util::print_log(__FILE__, __LINE__, erp42_racing_util::LogLevel::DEBUG   , msg, ##__VA_ARGS__)
#define ERP42_RACING_INFO(msg, ...)  erp42_racing_util::print_log(__FILE__, __LINE__, erp42_racing_util::LogLevel::INFO    , msg, ##__VA_ARGS__)
#define ERP42_RACING_WARN(msg, ...)  erp42_racing_util::print_log(__FILE__, __LINE__, erp42_racing_util::LogLevel::WARNING , msg, ##__VA_ARGS__)
#define ERP42_RACING_ERROR(msg, ...) erp42_racing_util::print_log(__FILE__, __LINE__, erp42_racing_util::LogLevel::ERROR   , msg, ##__VA_ARGS__)
...
#endif // ERP42_RACING_UTIL__LOG_HPP_