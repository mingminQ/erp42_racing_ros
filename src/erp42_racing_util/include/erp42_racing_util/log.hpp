...
#define ERP42_RACING_DEBUG(msg, ...) erp42_racing::log::print_log(__FILE__, __LINE__, erp42_racing::log::LogLevel::DEBUG   , msg, ##__VA_ARGS__)
#define ERP42_RACING_INFO(msg, ...)  erp42_racing::log::print_log(__FILE__, __LINE__, erp42_racing::log::LogLevel::INFO    , msg, ##__VA_ARGS__)
#define ERP42_RACING_WARN(msg, ...)  erp42_racing::log::print_log(__FILE__, __LINE__, erp42_racing::log::LogLevel::WARNING , msg, ##__VA_ARGS__)
#define ERP42_RACING_ERROR(msg, ...) erp42_racing::log::print_log(__FILE__, __LINE__, erp42_racing::log::LogLevel::ERROR   , msg, ##__VA_ARGS__)
