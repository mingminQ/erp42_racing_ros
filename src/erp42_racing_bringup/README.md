...
| --------------------------------------- | ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **erp42_racing_bringup_parameter_file** | -    | **serial_bridge** parameter file path                                                                                                                                                                                           |
...
| **launch_vehicle_description**          | bool | If **True**, **/erp42_racing/robot_description** will be published and the Transform will be broadcast. If **False**, **/erp42_racing/robot_description** will not be published, so the RobotModel will not be visible in Rviz. |
