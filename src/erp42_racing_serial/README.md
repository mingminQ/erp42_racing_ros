# erp42_racing_serial
ERP42 Racing serial communication package

<br/>

## serial_bridge
ROS2 communication interface and ERP42 Racing PCU serial packet conversion node 

```bash
$ ros2 launch erp42_racing_serial erp42_racing_serial_bridge.launch.py
```
