...
#ifndef ERP42_RACING_GAZEBO__GAZEBO_BRIDGE_HPP_
#define ERP42_RACING_GAZEBO__GAZEBO_BRIDGE_HPP_
...
namespace erp42_racing
{
     ...
     * @details Subscribes /erp42_racing/control_command, /erp42_racing/joint_states; 
     * publishes /erp42_racing/cmd_vel, /erp42_racing/feedback at 20 ms; 
     * serves /erp42_racing/mode_command; optionally uses /erp42_racing/set_joint_properties for braking. 
    ...
    private:
         ...
         */
        void control_command_callback(const erp42_racing_msgs::msg::ControlCommand::SharedPtr msg);
    ...
    private:
        ...
        rclcpp::Publisher<erp42_racing_msgs::msg::Feedback>::SharedPtr feedback_pub_;

        // Subscribers
        rclcpp::Subscription<erp42_racing_msgs::msg::ControlCommand>::SharedPtr control_command_sub_;
        rclcpp::Subscription<sensor_msgs::msg::JointState>::SharedPtr joint_state_sub_;

        // Services
        rclcpp::Service<erp42_racing_msgs::srv::ModeCommand>::SharedPtr mode_command_srv_;
        ...
        // Feedback data
        double  prev_rear_left_wheel_angle_ {0.0};
