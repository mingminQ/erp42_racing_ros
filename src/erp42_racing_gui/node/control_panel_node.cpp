 ...
 * @brief   ERP42 Racing platform Qt5 GUI control panel node
 * @author  Minkyu Kil
 * @date    2025-06-17
 * @version 1.0
 *
...
int main(int argc, char *argv[])
{
    ...
    // Dock widgets
    auto* control_panel    = new erp42_racing::ControlPanel(&main_window);
    auto* feedback_monitor = new erp42_racing::FeedbackMonitor(&main_window);
