...
#ifndef ERP42_RACING_GUI__CONTROL_PANEL_HPP_
#define ERP42_RACING_GUI__CONTROL_PANEL_HPP_
...
{
    /**
     * @brief ERP42 Racing Qt5 GUI control panel integrating a QDockWidget with an rclcpp::Node.
    ...
    private:
        ...
        // Publishers
        rclcpp::Publisher<erp42_racing_msgs::msg::ControlCommand>::SharedPtr control_command_pub_;

        // Service clients
        rclcpp::Client<erp42_racing_msgs::srv::ModeCommand>::SharedPtr mode_command_client_;

        // Control command
        erp42_racing_msgs::msg::ControlCommand control_command_msg_;

    }; // class ControlPanel

} // namespace erp42_racing

#endif // ERP42_RACING_GUI__CONTROL_PANEL_HPP_