...
#ifndef ERP42_RACING_GUI__FEEDBACK_MONITOR_HPP_
#define ERP42_RACING_GUI__FEEDBACK_MONITOR_HPP_
...
{
    /**
     * @brief ERP42 Racing feedback monitor implemented as a Qt5 dock widget and ROS 2 node.
     * @details Subscribes to /erp42_racing/feedback to display control mode, E-Stop, gear, speed (m/s),
     * steering (deg), brake, encoder, and heartbeat; reads and shows parameters from
     * "erp42_racing_serial_bridge" (port_path, baud_rate, max_speed, max_steering_deg, steering_offset_deg).
    ...
    private:
         ...
         */
        void feedback_callback(const erp42_racing_msgs::msg::Feedback::SharedPtr msg);
    ...
    private:
        ...
        // Subscribers
        rclcpp::Subscription<erp42_racing_msgs::msg::Feedback>::SharedPtr feedback_sub_;
...
#endif // ERP42_RACING_GUI__FEEDBACK_MONITOR_HPP_