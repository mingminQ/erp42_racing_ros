...
## ControlCommand.msg
ERP42 Racing control command includes speed, steering, brake
...
| **brake**    | uint8   | **0 - 100** | The braking strength of the vehicle. A value between **0 and 100** is required.                                                        |

<br/>

## Feedback.msg
Feedback information from ERP42 Racing
| Field              | Type    | Unit                          | Description                                                                                                |
| ------------------ | ------- | ----------------------------- | ---------------------------------------------------------------------------------------------------------- |
...
| **brake**          | uint8   | **0 - 100**                   | The vehicle's current brake strength.                                                                      |
| **encoder_count**  | int     | **-2^31 - 2^31**              | The counter of the vehicle's wheel encoder. **PPR : 48**                                                   |
| **battery**        | float64 | **V**                         | The voltage of the vehicle's battery                                                                       |
...
## ModeCommand.srv
ERP42 Racing mode command includes control mode, E-Stop, gear
...
| **emergency_stop** | bool  | **On / Off**                  | This field enables the emergency stop. If **true, the brake value is always 100 and the control input is ignored.** If false, the emergency stop is disabled.                                     |
