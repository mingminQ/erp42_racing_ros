 ...
 */
erp42_racing_rqt_plugin::FeedbackMonitorPlugin::FeedbackMonitorPlugin()
 ...
 */
void erp42_racing_rqt_plugin::FeedbackMonitorPlugin::initPlugin(qt_gui_cpp::PluginContext &context)
{
 ...
 */
void erp42_racing_rqt_plugin::FeedbackMonitorPlugin::shutdownPlugin()
{
 ...
 */
void erp42_racing_rqt_plugin::FeedbackMonitorPlugin::saveSettings(
 ...
 * @param instance_settings Instance-specific settings.
 */
void erp42_racing_rqt_plugin::FeedbackMonitorPlugin::restoreSettings(
 ...
 */
void erp42_racing_rqt_plugin::FeedbackMonitorPlugin::feedback_callback(
 ...
 * "erp42_racing_gazebo_control" node, depending on which one is available.
 ...
 */
void erp42_racing_rqt_plugin::FeedbackMonitorPlugin::read_vehicle_parameters()
{
    ...
    std::make_shared<rclcpp::SyncParametersClient>(node_, "erp42_racing_gazebo_control");
    ...
    else
    {
        ERP42_RACING_WARN(
            ...
            "Plugin expects 'serial_bridge' or 'erp42_racing_gazebo_control' node."
        );
        return;
    }
...
PLUGINLIB_EXPORT_CLASS(erp42_racing_rqt_plugin::FeedbackMonitorPlugin, rqt_gui_cpp::Plugin)