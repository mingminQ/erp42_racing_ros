 ...
 * @brief   ERP42 Racing platform RQT control panel GUI plugin
 * @author  Minkyu Kil
 * @date    2025-06-17
 * @version 1.0
 *
...
#include "erp42_racing_rqt_plugin/control_panel_plugin.hpp"
 ...
 */
erp42_racing::rqt_plugin::ControlPanelPlugin::ControlPanelPlugin()
 ...
 * @details This method creates a ROS 2 node named "erp42_racing_control_panel",
 ...
 */
void erp42_racing::rqt_plugin::ControlPanelPlugin::initPlugin(qt_gui_cpp::PluginContext &context)
{
    // Initialize ROS2 node
    node_ = std::make_shared<rclcpp::Node>("erp42_racing_control_panel");
    ...
    // Publishers
    control_command_pub_ = node_->create_publisher<erp42_racing_msgs::msg::ControlCommand>(
        "/erp42_racing/control_command",
        rclcpp::QoS(rclcpp::KeepLast(1)).durability_volatile().reliable()
    );

    // Service clients
    mode_command_client_ = node_->create_client<erp42_racing_msgs::srv::ModeCommand>(
 ...
 */
void erp42_racing::rqt_plugin::ControlPanelPlugin::shutdownPlugin()
{
 ...
 */
void erp42_racing::rqt_plugin::ControlPanelPlugin::saveSettings(
 ...
 */
void erp42_racing::rqt_plugin::ControlPanelPlugin::restoreSettings(
 ...
 */
void erp42_racing::rqt_plugin::ControlPanelPlugin::on_apply_mode_command()
{
 ...
 */
void erp42_racing::rqt_plugin::ControlPanelPlugin::bind_slider_spin_box(
 ...
 * @details
 *  - Publishes speed [m/s], steering [rad], and brake [0..100] at the timer rate.
 *  - Steering entered in degrees is converted to radians before publishing.
 */
void erp42_racing::rqt_plugin::ControlPanelPlugin::control_command_timer_callback()
{
...
PLUGINLIB_EXPORT_CLASS(erp42_racing::rqt_plugin::ControlPanelPlugin, rqt_gui_cpp::Plugin)