 ...
 */
erp42_racing_rqt_plugin::ControlPanelPlugin::ControlPanelPlugin()
 ...
 */
void erp42_racing_rqt_plugin::ControlPanelPlugin::initPlugin(qt_gui_cpp::PluginContext &context)
{
 ...
 */
void erp42_racing_rqt_plugin::ControlPanelPlugin::shutdownPlugin()
{
 ...
 */
void erp42_racing_rqt_plugin::ControlPanelPlugin::saveSettings(
 ...
 */
void erp42_racing_rqt_plugin::ControlPanelPlugin::restoreSettings(
 ...
 */
void erp42_racing_rqt_plugin::ControlPanelPlugin::control_command_timer_callback()
{
...
PLUGINLIB_EXPORT_CLASS(erp42_racing_rqt_plugin::ControlPanelPlugin, rqt_gui_cpp::Plugin)