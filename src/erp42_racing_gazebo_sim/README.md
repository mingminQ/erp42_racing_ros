# erp42_racing_gazebo_sim
ERP42 Racing Gazebo simulation package. Uses ERP42 Racing platform-related properties and control plugins to define ERP42 in Gazebo.
``` bash
$ ros2 launch erp42_racing_gazebo_sim gazebo_sim.launch.py
```
...
<div align="center">
  ...
  <br/>
  <figcaption>ERP42 Racing Gazebo-Sim simulation</figcaption>
...
``` xml
<!-- Include files -->
<xacro:include filename="$(find erp42_racing_gazebo_sim)/urdf/erp42_racing_description.xacro"/>

<!-- ERP42 Racing model description and gazebo control settings -->
<xacro:erp42_racing_description 
    base_link = "erp42_racing"
