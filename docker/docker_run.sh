...
# 
# [Devices]
# - ERP42 Racing serial port mounting to docker container
#
...
# ERP42 Racing serial port
ERP42_RACING_SERIAL_PORT="/dev/ttyUSB0"

# Declare an array variable
DEVICES=()

if [ -e "$ERP42_RACING_SERIAL_PORT" ]; then
  DEVICES+=(--device "$ERP42_RACING_SERIAL_PORT:$ERP42_RACING_SERIAL_PORT")
  echo "[ERP42 Racing] ✅"
else
  echo "[ERP42 Racing] ❌"
fi
